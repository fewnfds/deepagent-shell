...
class AutomationConfigField(BaseModel):
    ...
    def validate_keywords(self) -> "AutomationConfigField":
        string_options = (
            self.min_length,
            self.max_length,
            self.pattern,
...
class AutomationConfigSchema(BaseModel):
    ...
    @model_validator(mode="after")
    def validate_object_schema(self) -> "AutomationConfigSchema":
