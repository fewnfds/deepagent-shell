...
import {
  ...
  type WorkflowPrepareDefaults,
  type WorkflowPrepareDraft,
} from '@/domain/blocks'
...
const props = withDefaults(defineProps<{
  modelValue: WorkflowPrepareDraft
  defaults?: WorkflowPrepareDefaults
  catalog?: WorkflowPrepareCatalogItem[]
...
const emit = defineEmits<{
  'update:modelValue': [value: WorkflowPrepareDraft]
