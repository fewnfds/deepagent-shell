...
const resolutionKeys: Record<string, string> = {
  ...
  'contract.middleware_package_id_format_invalid': 'middlewarePackageIdFormatInvalid',
  ...
  'middleware_package.not_found': 'middlewarePackageNotFound',
  'middleware_package.invalid': 'middlewarePackageInvalid',
  'middleware_package.dependencies_failed': 'middlewarePackageDependenciesFailed',
  'middleware_package.dependencies_restart_required': 'middlewarePackageDependenciesRestartRequired',
  'middleware_package.config_invalid': 'middlewarePackageConfigInvalid',
