...
const resolutionKeys: Record<string, string> = {
  ...
  'assembly.worker_profile_not_found': 'workerProfileNotFound',
  'assembly.worker_profile_invalid': 'workerProfileInvalid',
  'assembly.worker_binding_required': 'workerBindingRequired',
  ...
  'contract.worker_name_required': 'workerNameRequired',
  'contract.worker_name_format_invalid': 'workerNameFormatInvalid',
  'contract.worker_description_required': 'workerDescriptionRequired',
  'contract.worker_name_duplicate': 'workerNameDuplicate',
