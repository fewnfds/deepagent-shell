  ...
  <PageShell>
    ...
    <div class="row g-3 align-items-start">
      <section class="col-lg-8">
        ...
        <section class="mb-3" aria-labelledby="primary-bindings-title">
          <header class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3">
            <h2 id="primary-bindings-title" class="h5 fw-semibold mb-0">
          ...
          <p v-if="form.subagents.length === 0" class="text-body-secondary">
            {{ t('agents.primary.noBindings') }}
          </p>
          <article
            v-for="(binding, index) in form.subagents"
            :key="index"
            class="card mb-3"
          ...
          >
            <header class="card-header d-flex flex-wrap align-items-center justify-content-between gap-2">
              ...
              <LteButton class="ms-auto" data-action="remove-binding" theme="danger" type="button" @click="removeBinding(index)">
                {{ t('common.remove') }}
              </LteButton>
            </header>
