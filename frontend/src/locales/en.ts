...
export const en: MessageSchema = {
  ...
  auto: {
    listTitle: 'Auto routing configurations',
    editorTitle: 'Auto script editor',
    empty: 'No Auto configuration exists.',
    publicId: 'Public model ID',
    source: 'Routing script (Python)',
    testTitle: 'Route test',
    testHint: 'Enter a chat message, run the preparation-stage script, and inspect the deterministic target.',
    test: 'Test route',
    saveBeforeTest: 'Save the Auto configuration before testing it.',
    saved: 'Auto configuration saved.',
    deleted: 'Auto configuration deleted.',
  },
  systemSettings: {
  ...
  errors: {
    ...
    autoNotFound: 'The Auto routing configuration does not exist.',
    autoPublicIdConflict: 'The Auto public model ID is already in use.',
    autoRevisionRequired: 'The current revision is required to update an Auto configuration.',
    workflowNotFound: 'The Workflow configuration does not exist.',
    workflowPublicIdConflict: 'The Workflow public model ID is already in use.',
  ...
  agents: {
    ...
    mainAgent: {
      ...
      publicId: 'Public model id',
      publicIdHint: 'Defaults to agent- plus the configuration name; use lowercase words separated by hyphens.',
