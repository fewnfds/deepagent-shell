...
export const en: MessageSchema = {
  ...
  workflow: {
    listTitle: 'Workflow configurations',
    editorTitle: 'Workflow editor',
    empty: 'No Workflow configuration exists.',
    nodesTitle: 'Nodes',
    addNode: 'Add node',
    edgesTitle: 'Edges',
    addEdge: 'Add edge',
    noEdges: 'No edge exists.',
    runTitle: 'Test run',
    runInput: 'Chat message',
    runApiKey: 'API key (page memory only)',
    runApiKeyHint: 'Remote mode requires the caller key configured on the API Server page. It is not saved to configuration or browser storage.',
    run: 'Run Workflow',
    runSaveRequired: 'Save the Workflow before running it.',
    runFailed: 'The Workflow run failed.',
    saved: 'Workflow saved.',
    deleted: 'Workflow deleted.',
    validationFailed: 'Workflow validation failed. Fix the reported issues before saving.',
    configJsonInvalid: 'Node configuration must be a valid JSON object.',
    inspectorTitle: 'Node inspector',
    configJson: 'Configuration JSON',
    timeout: 'Node timeout (seconds)',
    ...
    newEntry: 'New Entry Script',
    entryName: 'Model name (letters and hyphens only)',
    entryGraph: 'Target Graph',
    entrySource: 'Preparation script (optional)',
    entrySourcePlaceholder: 'def prepare(messages): return an object with messages and shared',
    entryNamePlaceholder: 'for example research-entry',
    entryNameHint: 'Only letters (upper or lower case) and hyphens are accepted.',
    entryEmpty: 'No Entry Script exists.',
    entrySaved: 'Entry Script saved.',
  ...
  library: {
    ...
    workflowDescription: 'Saved Graph definitions are managed here. Open a row to edit its canvas.',
    entryScriptDescription: 'Preparation scripts are plugin resources. Edit their source and target Graph here.',
  ...
  errors: {
    ...
    workflowNotFound: 'The Workflow configuration does not exist.',
    workflowReferenced: 'The Workflow is still referenced by another configuration.',
    workflowRevisionConflict: 'The Workflow was changed elsewhere. Reload it and try again.',
    workflowRevisionRequired: 'The current revision is required to update a Workflow.',
    workflowRevisionUnexpected: 'A new Workflow must not include a revision.',
  },
  resource: {
    error: {
      customTool: {
      ...
      automationScript: {
        invalidEncoding: 'Automation plugin files must use UTF-8 encoding.',
        readFailed: 'The automation plugin file could not be read.',
        linkUnsupported: 'Automation plugins do not support links or reparse points.',
        filesRequired: 'The plugin folder must contain script.json and main.py.',
        manifestInvalid: 'script.json does not satisfy the current plugin manifest.',
        idMismatch: 'The script.json id must match the folder name.',
        syntax: 'main.py contains a Python syntax error on line {line}.',
        entrypointRequired: 'main.py does not define the declared {entrypoint} entrypoint with the required sync or async form.',
        entrypointSignatureInvalid: 'The {entrypoint} entrypoint must accept exactly one positional ctx argument.',
        workflowNodeEntrypointRequired: 'main.py must define the declared async workflow node entrypoint.',
        workflowNodeEntrypointSignatureInvalid: 'A workflow node entrypoint must accept exactly one positional ctx argument.',
        workflowNodeTypeInvalid: 'Workflow node types must be namespaced by the plugin id.',
        workflowNodeTypeDuplicate: 'Workflow node types must be unique within one plugin.',
        idDuplicate: 'Automation plugin ids must be unique.',
  ...
  validation: {
    ...
    resolution: {
      ...
      pluginNotFound: 'Select an automation plugin that still exists.',
    ...
    issue: {
      ...
      assembly: {
        ...
        workflowSubagentNotFound: 'The Agent configuration referenced by the Workflow does not exist.',
      },
      automation: {
        pluginNotFound: 'Automation plugin {plugin_id} does not exist.',
