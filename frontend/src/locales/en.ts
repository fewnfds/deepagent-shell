...
export const en: MessageSchema = {
  ...
  fileManager: {
    ...
    roots: { files: 'Files', skill_templates: 'Skill Templates', python_templates: 'Python Templates' },
  ...
  editors: {
    ...
    pythonPackage: {
      ...
      filesHint: 'One package-relative path per line. Files are shown in this order.',
      pathInvalid: 'The path must be relative to the extension directory and cannot target package.json.',
      fileMissing: 'This file does not exist yet. Enter content and save to create it.',
      fileUnreadable: 'This file is not editable UTF-8 text. Entering new content will replace it with text.',
      status: {
  ...
  errors: {
    ...
    pythonPackageTemplateRequired: 'Select a Python code template or apply the empty template before saving.',
