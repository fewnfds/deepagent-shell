...
export const en: MessageSchema = {
  ...
  workflows: {
    ...
    searchPlaceholder: 'Search name, description, or Main Agent',
    ...
    mainAgentsLoadFailed: 'Could not load Main Agents',
    fields: {
      name: 'Name',
  ...
  capabilities: {
    ...
    other: {
      ...
      description: 'Deep Agents default summarization and prompt-caching Middleware',
    },
    'main-agent': {
      label: 'Main Agent',
  ...
  errors: {
    ...
    workflowMainAgentNotFound: 'The selected Main Agent does not exist.',
    workflowNotFound: 'The Workflow does not exist.',
    mainAgentReferencedByWorkflow: 'The Main Agent is still referenced by a Workflow.',
