...
export const en: MessageSchema = {
  ...
  workflows: {
    ...
    editor: {
      ...
      collapseInspector: 'Collapse properties',
  ...
  fields: {
    ...
    custom_transform_source: 'Python transform source',
    system_promote_min_chars: 'System-message character threshold',
    role: 'Message role',
    file: 'Primary virtual file',
    fallback_files: 'Fallback virtual files (one per line)',
    literal: 'Fixed fallback text',
    max_chars: 'Maximum appended characters',
  ...
  editors: {
    ...
    customMiddleware: {
      ...
      entriesTitle: 'Middleware packages',
      add: 'Add Middleware package',
    ...
    workflowInputContext: {
      ...
      promoteEnabled: 'Promote system messages at or above the character threshold to the top',
      demoteEnabled: 'Convert non-leading system messages below the character threshold to user messages',
      slotsTitle: 'Append messages',
      addSlot: 'Add slot',
  ...
  workflowComponents: {
    ...
    inputEndpoints: 'Input endpoints (JSON)',
    outputEndpoints: 'Output endpoints (JSON)',
    configSchema: 'Instance config schema (JSON Schema)',
    pythonSource: 'Python source',
    pythonRequirements: 'Python requirements',
    instanceConfig: 'Instance config (JSON)',
    invalidJson: 'Enter a valid JSON object or array for this field.',
    definitionSaved: 'The Workflow component definition was saved.',
    instanceSaved: 'The Workflow component instance was saved.',
    deleteDefinitionTitle: 'Delete Workflow component definition?',
    deleteDefinitionDescription: 'Delete the definition “{name}”?',
    deleteInstanceTitle: 'Delete Workflow component instance?',
    deleteInstanceDescription: 'Delete the instance “{name}”?',
  },
  terminology: {
    title: 'Terminology',
  ...
  errors: {
    workflowComponentDefinitionInvalid: 'The Workflow component definition is invalid ({count} issues).',
    workflowComponentDefinitionNotFound: 'The Workflow component definition does not exist.',
    workflowComponentDefinitionNameConflict: 'A Workflow component definition with this name already exists.',
    workflowComponentDefinitionInstancesInvalid: 'The changed schema would invalidate instance {instance}.',
    workflowComponentDefinitionReferenced: 'The definition still has instance {owner}.',
    workflowComponentInstanceInvalid: 'The Workflow component instance is invalid ({count} issues).',
    workflowComponentInstanceNotFound: 'The Workflow component instance does not exist.',
    workflowComponentInstanceConfigInvalid: 'The instance config does not match its schema at {path} ({keyword}).',
    workflowComponentInstanceNameConflict: 'An instance with this name already exists for the definition.',
    workflowComponentInstanceReferenced: 'The instance is still referenced by Workflow {owner}.',
  ...
  resource: {
    error: {
      ...
      middlewarePackage: {
        invalidEncoding: 'Middleware package files must use UTF-8 encoding.',
        readFailed: 'The Middleware package file could not be read.',
        linkUnsupported: 'Middleware packages do not support links or reparse points.',
        filesRequired: 'The package folder must contain middleware.json and main.py.',
        manifestInvalid: 'middleware.json does not satisfy the current package manifest.',
        idMismatch: 'The middleware.json id must match the folder name.',
        syntax: 'main.py contains a Python syntax error on line {line}.',
        entrypointRequired: 'main.py must define a synchronous create_middleware(ctx) entrypoint.',
        entrypointSignatureInvalid: 'create_middleware must accept exactly one positional ctx argument.',
        idDuplicate: 'Middleware package ids must be unique.',
  ...
  validation: {
    ...
    resolution: {
      ...
      middlewarePackageIdFormatInvalid: 'Start the Middleware package identifier with a lowercase letter or digit, then use only lowercase letters, digits, or hyphens, and save again.',
      ...
      middlewarePackageNotFound: 'Select a Middleware package that still exists.',
      middlewarePackageInvalid: 'Correct the Middleware package or select another package.',
      middlewarePackageDependenciesFailed: 'Correct the package requirements and restart Agent Shell.',
      middlewarePackageDependenciesRestartRequired: 'Restart Agent Shell to prepare the package requirements.',
      middlewarePackageConfigInvalid: 'Correct the package fields that do not satisfy its configuration schema.',
    ...
    issue: {
      ...
      contract: {
        ...
        middlewarePackageIdFormatInvalid: '{field} must start with a lowercase letter or digit and then contain only lowercase letters, digits, or hyphens.',
      ...
      middlewarePackage: {
        notFound: 'Middleware package {package_id} does not exist.',
        invalid: 'Middleware package {package_id} failed static validation.',
        dependenciesFailed: 'Python dependencies for Middleware package {package_id} could not be prepared.',
        dependenciesRestartRequired: 'Restart Agent Shell to prepare Python dependencies for Middleware package {package_id}.',
        configInvalid: 'Configuration for Middleware package {package_id} is invalid ({keyword}).',
      },
      storage: {
