...
export const en: MessageSchema = {
  ...
  editors: {
    ...
    pythonPackage: {
      title: 'Private Python package',
      template: 'Code template',
      selectTemplate: 'Select a template',
      folder: 'Private package folder',
      mainSource: 'main.py',
  ...
  errors: {
    ...
    pythonPackageFolderImmutable: 'An existing configuration cannot change its private package folder.',
    pythonPackageComponentUnsupported: 'This component type does not support a private Python package.',
    pythonPackageInvalid: 'The private Python package is invalid.',
    pythonPackageReadFailed: 'The private Python package could not be read. Use the error code and request ID to inspect the package files and Debug log.',
    pythonPackageNotFound: 'The private Python package does not exist or is not owned by this configuration.',
    ...
    pythonPackageRevisionConflict: 'The private Python package changed. Reload it before saving.',
  ...
  validation: {
    ...
    resolution: {
      ...
      pythonPackageFolderFormatInvalid: 'Reload the configuration so its private package folder reference can be restored.',
      ...
      pythonPackageConfigInvalid: 'Correct the package fields that do not satisfy its configuration schema.',
    ...
    issue: {
      ...
      contract: {
        ...
        pythonPackageFolderFormatInvalid: '{field} must be a configuration-owned private package folder.',
      ...
      pythonPackage: {
        ...
        configInvalid: 'Configuration for Python package {package_id} is invalid ({keyword}).',
      },
      storage: {
