...
export const en: MessageSchema = {
  ...
  fields: {
    ...
    max_execute_timeout: 'Maximum execute timeout (seconds)',
    summarization: {
    ...
    system_promote_min_chars: 'Minimum system-message characters',
    role: 'Message role',
  ...
  editors: {
    ...
    workflowInputContext: {
      ...
      demoteEnabled: 'Convert remaining non-leading system messages to user messages',
      slotsTitle: 'Appended message slots',
      addSlot: 'Add slot',
