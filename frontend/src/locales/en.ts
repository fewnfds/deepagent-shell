...
export const en: MessageSchema = {
  ...
  validation: {
    ...
    resolution: {
      ...
      pythonPackageIdFormatInvalid: 'Use the canonical lowercase UUID from the Python package manifest, then save again.',
      ...
      pythonPackageBindingRequired: 'Select exactly one enabled Python package.',
    ...
    issue: {
      ...
      contract: {
        ...
        pythonPackageIdFormatInvalid: '{field} must be a canonical lowercase UUID.',
      ...
      pythonPackage: {
        bindingRequired: 'Select exactly one enabled Python package for this Condition Router.',
