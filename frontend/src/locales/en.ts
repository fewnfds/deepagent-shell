...
export const en: MessageSchema = {
  ...
  editors: {
    ...
    conditionRouter: {
      ...
      branchesHint: 'Branch keys are the values returned by the script. Otherwise is required and is used when no branch is activated.',
      addBranch: 'Add branch',
      removeBranch: 'Remove branch',
      scriptTitle: 'Routing script',
      scriptHint: 'Define async def route(state, context). Both arguments contain the complete Workflow runtime values. Return activate (one or more keys) and update (a partial State mapping).',
    },
    scriptRequirements: {
  ...
  validation: {
    ...
    issue: {
      ...
      workflow: {
        ...
        conditionRouterBranchUnknown: 'Branch {branch_key} is not declared by the selected Condition Router.',
