...
export const en: MessageSchema = {
  ...
  editors: {
    ...
    conditionRouter: {
      ...
      scriptHint: 'Define async def route(state, context). Return activate (one or more branch Edge keys) and update (a partial State mapping); an empty activate uses otherwise.',
    },
    scriptRequirements: {
