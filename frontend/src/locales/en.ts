...
export const en: MessageSchema = {
  ...
  workflows: {
    ...
    editor: {
      ...
      stateCondition: 'State / Context conditional routing',
      ...
      removeCondition: 'Remove Condition node',
      ...
      agent: 'Agent',
      condition: 'Condition',
      conditionSource: 'Read source',
      conditionPath: 'JSON Pointer',
      conditionOperator: 'Comparison operator',
      conditionValue: 'JSON comparison value',
      jsonPointer: 'Use an RFC 6901 path; leave empty to read the full source.',
      invalidJsonValue: 'Enter a valid JSON value.',
      end: 'End',
  ...
  validation: {
    ...
    issue: {
      ...
      workflow: {
        ...
        endpointConnectionLimitExceeded: 'The Workflow endpoint has too many connections.',
        nodeRoutingMixed: 'A Workflow node cannot mix static and conditional routing.',
        conditionRouteMissing: 'Every Condition output must connect to a target node.',
