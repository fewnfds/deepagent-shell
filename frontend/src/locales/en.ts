...
export const en: MessageSchema = {
  ...
  workflows: {
    ...
    editor: {
      ...
      removeConditionRouter: 'Remove Condition Router node',
      removeTaskDispatcher: 'Remove Task Dispatcher node',
      conditionRouter: 'Condition Router',
      conditionRouterConfig: 'Condition Router configuration',
      noConditionRouters: 'No Condition Router is configured',
      noConditionRouterSelected: 'No Condition Router selected',
      taskDispatcher: 'Task Dispatcher',
      ...
      canvasProblems: {
        title: 'Problems',
        none: 'No problems are blocking save.',
        mainAgentRequired: 'Select a Main Agent.',
        conditionRouterRequired: 'Select a Condition Router configuration.',
  ...
  workflowLifecycles: {
    title: 'Workflow run lifecycles',
    tableAriaLabel: 'Workflow run lifecycle list',
    empty: 'No Workflow run lifecycle exists.',
    filteredEmpty: 'No run lifecycle matches the current query.',
    loadFailed: 'Could not load run lifecycles',
    searchPlaceholder: 'Search Workflow, Lifecycle, or request ID',
    columns: {
      workflow: 'Workflow',
      created: 'Created',
      parentStatus: 'Parent Run',
      tasks: 'Active / all tasks',
      checkpoints: 'Checkpoints',
      storeItems: 'Store items',
      dynamicDirectories: 'Dynamic directories',
    },
    parentStatuses: {
      running: 'Running',
      completed: 'Completed',
    ...
    deleteTitle: 'Delete run lifecycle',
    deleteDescription: 'Delete Store data, checkpoints, and managed dynamic directories for “{name}”?',
    deleted: 'Run lifecycle deleted.',
    deleteFailed: 'Could not delete run lifecycle',
  },
  systemSettings: {
    ...
    invalid: 'The port, initial message limit, and configuration alert interval must be valid integers.',
  ...
  eventFeed: {
    ...
    retention: {
      ...
      workflowDebug: 'Workflow Debug history',
      workflowDebugConfirmDescription: 'Keep only the newest {count} completed Workflow Debug records? Checkpoints remain owned by their Lifecycle.',
    ...
    feedback: {
      ...
      workflowDebugRetentionSaved: 'Workflow Debug history now keeps {count} records.',
  ...
  capabilities: {
    ...
    'condition-router': {
      ...
      description: 'Run a user-authored Python decision and route with LangGraph Command',
    },
    'task-dispatcher': {
  ...
  editors: {
    ...
    outputMode: {
      ...
      scriptHint: 'Define synchronous def output(event), read the event dict, and return a string.',
      events: {
  ...
  errors: {
    ...
    workflowDebugRunActive: 'A running Workflow Debug run cannot be deleted.',
    workflowLifecycleNotFound: 'The Workflow run lifecycle does not exist.',
  ...
  validation: {
    ...
    issue: {
      ...
      workflow: {
        documentTooLarge: 'The Workflow document is too large.',
        ...
        conditionRouterNotFound: 'The selected Condition Router configuration does not exist.',
        conditionRouterBranchMissing: 'Connect branch {branch_key} to a target.',
