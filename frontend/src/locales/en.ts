...
export const en: MessageSchema = {
  ...
  validation: {
    ...
    resolution: {
      ...
      pluginIdFormatInvalid: 'Start the plugin identifier with a lowercase letter or digit, then use only lowercase letters, digits, or hyphens, and save again.',
    ...
    issue: {
      ...
      contract: {
        ...
        pluginIdFormatInvalid: '{field} must start with a lowercase letter or digit and then contain only lowercase letters, digits, or hyphens.',
