export const zhCN = {
  ...
  workflows: {
    ...
    editor: {
      ...
      removeConditionRouter: '删除条件路由节点',
      removeTaskDispatcher: '删除任务分发节点',
      conditionRouter: '条件路由',
      conditionRouterConfig: '条件路由配置',
      noConditionRouters: '尚未配置条件路由',
      noConditionRouterSelected: '未选择条件路由',
      taskDispatcher: '任务分发',
      ...
      canvasProblems: {
        ...
        conditionRouterRequired: '请选择条件路由配置。',
  ...
  workflowLifecycles: {
    title: 'Workflow 运行生命周期',
    tableAriaLabel: 'Workflow 运行生命周期列表',
    empty: '尚无 Workflow 运行生命周期。',
    filteredEmpty: '没有符合当前条件的运行生命周期。',
    loadFailed: '无法载入运行生命周期',
  ...
  eventFeed: {
    ...
    retention: {
      ...
      workflowDebug: 'Workflow Debug 历史',
      workflowDebugConfirmDescription: '只保留最近 {count} 条已完成的 Workflow Debug 记录？Checkpoint 仍由 Lifecycle 管理。',
    ...
    feedback: {
      ...
      workflowDebugRetentionSaved: 'Workflow Debug 历史现在保留 {count} 条记录。',
  ...
  capabilities: {
    ...
    'condition-router': {
      label: '条件路由',
      description: '运行用户编写的 Python 判断，并通过 LangGraph Command 路由',
    },
    'task-dispatcher': {
      label: '任务分发',
  ...
  editors: {
    ...
    outputMode: {
      ...
      scriptHint: '定义同步 def output(event)，读取 event dict 并返回字符串。',
      events: {
  ...
  errors: {
    ...
    workflowDebugRunActive: '无法删除正在运行的 Workflow Debug 记录。',
    workflowLifecycleNotFound: 'Workflow 运行生命周期不存在。',
  ...
  validation: {
    ...
    issue: {
      ...
      workflow: {
        documentTooLarge: 'Workflow 文档过大。',
        ...
        conditionRouterNotFound: '所选条件路由配置不存在。',
        conditionRouterBranchMissing: '请把分支 {branch_key} 连接到目标节点。',
