export const zhCN = {
  ...
  validation: {
    ...
    resolution: {
      ...
      pythonPackageIdFormatInvalid: '请使用 Python 包清单中的小写规范 UUID，然后重新保存。',
      ...
      pythonPackageBindingRequired: '选择且只启用一个 Python 包。',
    ...
    issue: {
      ...
      contract: {
        ...
        pythonPackageIdFormatInvalid: '{field}必须是小写规范 UUID。',
      ...
      pythonPackage: {
        bindingRequired: '请为该条件路由选择且只启用一个 Python 包。',
