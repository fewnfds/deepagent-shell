export const zhCN = {
  ...
  workflows: {
    ...
    editor: {
      ...
      stateCondition: 'State / Context 条件路由',
      ...
      target: '目标端口',
      removeEdge: '删除 Edge',
      removeCondition: '删除 Condition 节点',
      ...
      agent: 'Agent',
      condition: 'Condition',
      conditionSource: '读取来源',
      conditionPath: 'JSON Pointer',
      conditionOperator: '比较操作',
      conditionValue: 'JSON 比较值',
      jsonPointer: '使用 RFC 6901 路径；空值读取整个来源。',
      invalidJsonValue: '请输入有效的 JSON 值。',
      end: 'End',
  ...
  validation: {
    ...
    issue: {
      ...
      workflow: {
        ...
        endpointConnectionLimitExceeded: 'Workflow 端口超过允许的连接数量。',
        nodeRoutingMixed: '同一 Workflow 节点不能混用静态与条件路由。',
        conditionRouteMissing: 'Condition 的每个出口都必须连接目标节点。',
