...
data/
  config/
    ...
    python_package_instances/{workflow-prepare,condition-router,task-dispatcher,agent-middleware}/
  ...
  templates/{workflow/prepare,workflow/condition_router,workflow/task_dispatcher,agent/custom_middleware}/
...
Python templates scope 用于在 `workflow/prepare/`、`workflow/condition_router/`、`workflow/task_dispatcher/` 或 `agent/custom_middleware/` 类别中建档静态代码模板。
